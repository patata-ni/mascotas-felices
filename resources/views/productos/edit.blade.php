    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="descripcion" 
                              rows="3"
                              class="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-[#4A3DB8] @error('descripcion') border-red-500 @enderror">{{ old('descripcion', $producto->descripcion) }}</textarea>
                    @error('descripcion')
                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                    @enderror
                </div>
        ...
        <div class="space-y-6">
            ...
            <div class="bg-white rounded-lg shadow-lg p-6">
                ...
                <div x-data="{ preview: '{{ $producto->imagen ? asset('storage/' . $producto->imagen) : null }}' }" class="space-y-4">
                    ...
                    <input type="file" 
                           name="imagen" 
                           accept="image/*"
                           @change="preview = $event.target.files.length > 0 ? URL.createObjectURL($event.target.files[0]) : '{{ $producto->imagen ? asset('storage/' . $producto->imagen) : null }}'"
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="md:col-span-2 bg-gray-50 p-4 rounded-lg">
                    <div class="flex items-center justify-between text-sm">
                        ...
                        <span class="font-bold text-[#5B8FCC]">
        ...
        <div class="bg-white rounded-lg shadow-lg p-6">
            ...
            <div class="space-y-4">
                ...
                @if($producto->stockBajo())
                    <div class="bg-[#FFF5F0] border border-yellow-200 rounded-lg p-3">
                        <div class="flex items-center text-[#E89A7B]">
                            <i class="fas fa-exclamation-triangle mr-2"></i>
                            <span class="text-sm font-medium">Stock bajo - Reabastecer pronto</span>
                        </div>
                    </div>
                @endif
            </div>
