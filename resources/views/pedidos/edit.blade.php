...
<div class="mb-6">
    <div class="flex items-center text-sm text-gray-600 mb-4">
        ...
        <span class="text-gray-800">Editar: {{ $pedido->numero_pedido }}</span>
    </div>
    <h1 class="text-3xl font-bold text-gray-800">Editar Pedido</h1>
</div>

<div x-data="pedidoForm(@json($pedido))" x-init="init()">
